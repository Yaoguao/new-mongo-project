...
mongosh "mongodb://localhost:27017/TestDiary" <<EOF
db.students.insertMany([
    {
      "_id": {
        "$oid": "6653a40280aa77729c0c70f8"
      },
      "name": "Pasha",
      "email": "kii@gmail.com",
...
db.subjects.insertMany([
    {
      "_id": {
        "$oid": "6654f2acb7d8890cee94313f"
      },
      "name": "Math",
      "teacherId": "6654f21fb7d8890cee94313e",
      "gradesStudents": {
        "6653a40280aa77729c0c70f8": [
          2,
          3,
          4,
          5
        ],
        "6654f1a9b7d8890cee94313d": [
          5,
          5,
          5,
          5,
